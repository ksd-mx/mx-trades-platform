...
#     --set esConfig."elasticsearch\\.yml"="xpack.security.enabled: true" \
#     --set secret.password="elastic123!" \
#     --set discovery.type=single-node 

# # Wait for Elasticsearch to be fully ready
# echo "⏳ Waiting for Elasticsearch to be ready..."
# kubectl wait --for=condition=ready pod -l app=elasticsearch-master -n logging --timeout=3000s
...
#     --set "elasticsearch.auth.username=elastic" \
#     --set "elasticsearch.auth.password=$elastic123!" \
